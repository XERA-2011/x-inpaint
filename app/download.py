...
from app.schema import ModelType, ModelInfo
...
from app.model.original_sd_configs import get_config_files


def cli_download_model(model: str):
    from app.model import models
    from app.model.utils import handle_from_pretrained_exceptions
